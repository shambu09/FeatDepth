...
if __name__ == "__main__":
    cfg_path = r'..\config\cfg_kitti_fm.py'  # path to cfg file
    model_path = r'C:\Users\Shambu\Documents\GitHub forked repos\FeatDepth\weights\fm_depth.pth'  # path to model weight
    img_path = r'..\assets\test.png'
    output_path = r'..\assets\test_disp.png'  # dir for saving depth maps
